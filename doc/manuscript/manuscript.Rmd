...
Each mycelial mat was collected in a filtered Buchner funnel, agar plugs removed, lyophilized and pulverized manually in Whirl-pak HDPE sampling bags (Sigma-Aldrich, St. Louis, MO). 
...
](../../results/figures/publication/mcg-subgraph-with-context.pdf){#biggraph} {width=50%,height=50%}
...
](../../results/figures/publication/Figure7Z.pdf){#rda-biplot width=61%, height=65%}
...
](../../results/figures/publication/mlg-11.pdf){#community-graph height=40%} 
...
](../../results/figures/publication/DAPC.pdf){#DAPC height=40%}
...
](../../results/figures/publication/dapc_region_year_micanewa.pdf){#DAPC-RY width=61%,height=61%}
...
](images/mcg-trimmed.png){#mcg-fig height=30%}
...
](../../results/figures/publication/RMM-aggressiveness.pdf){#mcg-mlh-region-aggressiveness height=50%}
...
](../../results/figures/publication/full-graph.pdf){#fullgraph width=50%, height=50%}
...
The shade and area of the nodes are proportional to the number of unique MLHs within the node and the inner nodes are proportional to the number of private MLHs to the region (bottom legend). 
Each edge represents a single MLH where its thickness represents the number of populations that share the MLH and the shade represents the value of $P_{sex}$, or the probability of encountering that MLH from two independent meiotic events.
](../../results/figures/publication/mlg-16.pdf){#community-graph16 height=50%} 
...
Points (text labels) represent observed individuals connected to the population centroids with ellipses representing a 66% confidence interval for a normal distribution. 
The center of each component is represented as black grid lines.
](../../results/figures/publication/dapc_region_year.pdf){#DAPC-RY-FULL height=50%}
