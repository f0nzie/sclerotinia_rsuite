...
# Multilocus Genotype And Mycelial Compatability Group Assessment
...
if (!interactive())
  ggsave(t5g, file = file.path(PROJHOME, "results", "figures", "publication", "mcg-mlg-subgraph.pdf"), width = 88, height = 88, scale = 3, units = "mm")
```
...
severity_plot
if (!interactive())
  ggsave(severity_plot, filename = file.path(PROJHOME, "results/figures/publication/RMM-aggressiveness.pdf"), width = 183, height = 183*(4.5/7), unit = "mm")
```
